...
def Newtons_Coupling(superlink, inlet, P, P_new, H, H_new, Q, Q_new, dt, k):
    # FIXME: use epsilon method instead
    rho = 1000
...
inlet_poly = [[3, 2.5], [3,3.5], [4, 3.5], [4,2.5], [3,2.5]]
outlet_poly = [[8, 2.5], [8,3.5], [9, 3.5], [9,2.5], [8,2.5]]

# inlet_anuga_region = anuga.Region(domain, radius=1.0, center=(7., 1.))
# outlet_anuga_region = anuga.Region(domain, radius=1.0, center=(17., 3.))
inlet_anuga_region = anuga.Region(domain, polygon=inlet_poly)
outlet_anuga_region = anuga.Region(domain, polygon=outlet_poly)

# input1_anuga_region =  anuga.Region(domain, radius=1.0, center=(2., 1.))
...
# input1_anuga_inlet_op = anuga.Inlet_operator(domain, input1_anuga_region, Q=input_velocity) #only inlet1 has water inflow.
